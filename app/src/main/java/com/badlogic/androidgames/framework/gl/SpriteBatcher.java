...
public class SpriteBatcher {        
    ...
    public void drawSprite(float x, float y, float width, float height, TextureRegion region,float blend) {
        ...
        verticesBuffer[bufferIndex++] = 1;
        verticesBuffer[bufferIndex++] = 1;
        verticesBuffer[bufferIndex++] = blend;
    ...
    public void drawSprite(float x, float y, float width, float height, TextureRegion region,float r,float
    		g,float b,float a) {
        float halfWidth = width / 2;
        float halfHeight = height / 2;
        float x1 = x - halfWidth;
